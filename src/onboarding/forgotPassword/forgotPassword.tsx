            ...
            <div className="md:w-1/2 md:rounded-xl md:bg-[#FFFFFF]">
                <div className="flex flex-col items-center justify-center text-center py-10 md:m-auto lg:w-2/3 xl:w-1/2">
                    ...
                    <div className="p-4 bg-white">
                        {/* Email section */}
                        <div className="mb-10">
                            <div className={`relative w-full flex border border-gray-300 rounded-md ${isMailFocused || forgotMail ? "border-green-600" : ""}`}>
                                <button className={`pl-2 ${isMailFocused || forgotMail ? "hidden" : "block"}`}>
